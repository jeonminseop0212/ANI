...
class ANICommunityView: UIView {
  ...
  private func setup() {
    ...
    collectionView.contentInset = UIEdgeInsets(top: ANICommunityViewController.NAVIGATION_BAR_HEIGHT, left: 0, bottom: 0, right: 0)
    collectionView.scrollIndicatorInsets  = UIEdgeInsets(top: ANICommunityViewController.NAVIGATION_BAR_HEIGHT, left: 0, bottom: 0, right: 0)
    ...
    self.communityCollectionView = collectionView
  }
...
extension ANICommunityView: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
